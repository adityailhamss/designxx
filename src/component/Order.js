...
function Order() {
    ...
    return (
        ...
        <div className='py-20 lg:flex flex-row justify-between items-baseline'>
                ...
                <div className='flex  justify-items-end '>
                    <button onClick={() => setShowMyModal(true)} className='text-[#E9520B]'>GANTI PAKET</button>
                </div>
        </div>
        ...
        <div className='py-10 flex flex-col gap-3'>
            <h1 className='font-bold text-3xl text-[#414141]'>Billing information</h1>
            <p className='text-sm text-left text-[#414141]'>We'll use this information to issue the first invoice. You'll be able to update the details for future invoices from your account profile.</p>
            </div>
    <div className='flex flex-col'>
            <div className='box-o-5'>
                ...
                <input class="shadow appearance-none border rounded w-80 lg:w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nama" type="text" placeholder="Nama Lengkap" />
            </div>
            <div className='box-o-5'>
                <label class="block mb-2 font-bold" for="alamat">
                    Alamat
                </label>
                <input class="shadow appearance-none border rounded w-80 lg:w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="alamat" type="text" placeholder="Alamat" />
            </div>
            <div className='box-o-5'>
                <label class="block mb-2 font-bold" for="email">
                    Email
                </label>
                <input class="shadow appearance-none border rounded w-80 lg:w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" placeholder="Email" />
            </div>
            <div className='box-o-5'>
                <label class="block mb-2 font-bold" for="telepon">
                    No Handphone/Telepon
                </label>
                <input class="shadow appearance-none border rounded w-80 lg:w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="telepon" type="text" placeholder="No Handphone" />
            </div>
            <div className='box-o-5'>
                <label class="block mb-2 font-bold" for="perusahaan">
                    Perusahaan
                </label>
                <input class="shadow appearance-none border rounded w-80 lg:w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="perusahaan" type="text" placeholder="Perusahaan" />
            </div>
            </div>

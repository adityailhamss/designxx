      ...
      <div className="flex flex-col-reverse lg:flex-row items-center w-full lg:ml-20 xl:w-[90%] mx-auto gap-5">
        <div className="flex flex-col w-full lg:w-1/2 gap-8 text-[#414141]">
          <h1 className="font-bold text-3xl lg:text-6xl lg:leading-[4.5rem] text-center lg:text-left">
            <span className="font-[600px]"></span> On-demand design services that save time and money
          </h1>
          <p className='border-solid border-[3px] border-black lg:w-[100px] h-0'></p>
          <p className='text-center lg:text-left '>Fueled by a dedicated global<br/>
           workforce, DesignXX combines<br/> tech and talent, offering a design<br/> solution that can make work work<br/> for you. </p>
           <div className='flex flex-row '>
           <button className='items-center border-solid border-[1px] border-[#E9520B] w-[307px] h-[54px] left-[106px] bg-[#E9520B] rounded text-white uppercase font-[DM Sans] font-normal text-2xl text-center'> LIHAT PROJECT </button>
            <img className='left-[35.79%] right-[33.33%] top-[25%] bottom-[25%] bg-[#E9520B]' src='assets/img/Icon.png'/> 
          </div>
          </div>
         ...
         <p className="w-[167px] h-[72px] left-[456px] ml-3 mt-2 top-[841px] font-normal text-2xl lg:leading-9 text-white">
          ...
          <p className='w-[167px] h-[72px] left-[528px] top-[942px font-[Poppins] font-semibold text-end text-7xl mt-10 text-[#E5E5E5]'>01</p>
          </h1>
          </div>
          ...
          <h1 className='w-[167px] h-[72px] left-[528px] top-[942px font-[Poppins] font-semibold text-end text-7xl mt-10 text-[#E5E5E5]'>02</h1>
          </div> 
          <div className="flex flex-col w-full items-center lg:w-[205px] lg:h-[205px] bg-gradient-to-t from-[#FFFFFF] to-[#E5E5E5]">
          <p className="w-[167px] h-[72px] left-[456px] top-[841px] font-normal text-2xl lg:leading-9 text-[#414141]">
          You've Got a Design
          </p>
          <h1 className='w-[167px] h-[72px] left-[528px] top-[942px font-[Poppins] font-semibold text-end text-7xl mt-10 text-[#E5E5E5]'>03</h1>
          </div> 
          </div>
          </div>
          ...
          <p className='font-[Poopins] font-medium text-lg leading-8 lg:text-left text-center text-[#9F9F9F]'>Let's discuss what projects<br/>
          you have in mind</p>
          <div className='flex flex-row '>
           <button className='border-solid border-[1px] border-[#E9520B] w-[307px] h-[54px] left-[106px] bg-[#E9520B] rounded text-white uppercase font-[DM Sans] font-normal text-2xl text-center'> SELENGKAPNYA </button>
            <img className='left-[35.79%] right-[33.33%] top-[25%] bottom-[25%] bg-[#E9520B]' src='assets/img/Icon.png'/> 
          </div>
          </div>
          </div>
          <div className='flex flex-col-reverse lg:flex-row w-full items-center xl:w-[90%] gap-[75px] lg:ml-20 '>
            <div className='flex flex-col gap-[17px] lg:w-[398px] lg:[h-144px] '>
              ...
              <p className='lg:text-left text-center text-[#9F9F9F]'>We have helped startups around<br/> 
                 the globe as well as fortune<br/>
                 500 companies</p>
              <div className='flex flex-row gap-8 items-center lg:text-left lg:justify-start justify-center'>
                <button className='font-sans font-normal text-2xl leading-[54px] uppercase text-[#E9520B] lg:text-left text-center'>CONTACT US</button>
                <img className=' h-6 left-[35.79%] right-[33.33%] top-[25%] bottom-[25%]' src='assets/img/icon1.png'/>
              </div>
          </div>
          <div>
          ...
          <div className='flex flex-col-reverse lg:flex-row w-full gap-[110px] xl:w-[90%] lg:ml-20'>
           ...
           <button className='items-center justify-center border-solid border-[1px] border-[#E9520B] lg:w-[275px] lg:h-[54px] bg-[#E9520B] rounded text-white uppercase font-[DM Sans] font-normal text-2xl text-center'> LIHAT SEMUA </button>
            <img className='left-[35.79%] right-[33.33%] top-[25%] bottom-[25%] bg-[#E9520B]' src='assets/img/Icon.png'/> 
          </div>
            </div>
            </div>
            <div className='flex flex-col gap-[17px]'>
              <h1 className='font-[Poppins] font-semibold text-[64px] leading-[72px] lg:text-left text-center text-[#414141]'>What<br/> We Do?</h1>
          ...
          <div className='flex flex-col-reverse lg:flex-row w-full xl:w-[90%] gap-[37px] lg:ml-20'>
            ...
            Get the production and quality of an<br/> in-house team without the overhead<br/> cost.
            </p>
            <div className='flex flex-row gap-8 items-center lg:text-left lg:justify-start justify-center'>
                <button className='font-sans font-normal text-2xl leading-[54px] uppercase text-[#E9520B] lg:text-left text-center'>SELENGKAPNYA</button>
                <img className=' h-6 left-[35.79%] right-[33.33%] top-[25%] bottom-[25%]' src='assets/img/icon1.png'/>
              </div>
            </div>
            <div className='flex flex-col lg:flex-row lg:w-321 lg:h-363 gap-[37px] mt-4'>
              <div className='flex flex-col gap-12 lg:w-[321px] lg:h-[363px]'>
                <div className='flex flex-row gap-[28px]'>
                  <img className=' w-14 h-14 bg-[#FFEFE8] p-[16px] rounded-[50px]'  src="./assets/adp/image1.png" />
                <div className='flex flex-col'>
              <h1 className='font-[Poppins] font-semibold text-lg leading-[27px] text-[#414141]'>
              Unlimited revisions
              </h1>
              <p className='font-[Poppins] font-medium text-xs leading-[18px] text-[#9F9F9F]'>Not happy yet with your design?<br/> Submit as many revisions as you need<br/> until it pops!</p>
              </div>
              </div>
              <div className='flex flex-row gap-[28px]'>
                  <img className=' w-14 h-14 bg-[#FFEFE8] p-[16px] rounded-[50px]'  src="./assets/adp/image2.png"/>
                <div className='flex flex-col'>
              <h1 className='font-[Poppins] font-semibold text-lg leading-[27px] text-[#414141]'>
              Fixed monthly rate
              </h1>
              <p className='font-[Poppins] font-medium text-xs leading-[18px] text-[#9F9F9F]'>Why pay more? Save thousands of dollars paying by the month instead of per design.</p>
              </div>
              </div>
              <div className='flex flex-row gap-[28px]'>
                  <img className=' w-14 h-14 bg-[#FFEFE8] p-[16px] rounded-[50px]'  src="./assets/adp/image3.png" />
                <div className='flex flex-col'>
              <h1 className='font-[Poppins] font-semibold text-lg leading-[27px] text-[#414141]'>
              1-2 day turnaround
              </h1>
              <p className='font-[Poppins] font-medium text-xs leading-[18px] text-[#9F9F9F]'>Always know how long your designs will take. Never wait more than 2 days for designs.</p>
              </div>
              </div>
              </div>
              <div className='flex flex-col gap-12 lg:w-[321px] lg:h-[363px]'>
                <div className='flex flex-row gap-[28px]'>
                  <img className=' w-14 h-14 bg-[#FFEFE8] p-[16px] rounded-[50px]'  src="./assets/adp/image4.png" />
                <div className='flex flex-col'>
              <h1 className='font-[Poppins] font-semibold text-lg leading-[27px] text-[#414141]'>
              Brand folders
              </h1>
              <p className='font-[Poppins] font-medium text-xs leading-[18px] text-[#9F9F9F]'>Keep your brand’s assets on Penji so your designers can match your style.</p>
              </div>
              </div>
              <div className='flex flex-row gap-[28px]'>
                  <img className=' w-14 h-14 bg-[#FFEFE8] p-[16px] rounded-[50px]'  src="./assets/adp/image5.png"/>
                <div className='flex flex-col'>
              <h1 className='font-[Poppins] font-semibold text-lg leading-[27px] text-[#414141]'>
              Vetted designers
              </h1>
              <p className='font-[Poppins] font-medium text-xs leading-[18px] text-[#9F9F9F]'>We take our quality seriously. Only 2% of designers that apply to Penji make the team.</p>
              </div>
              </div>
              <div className='flex flex-row gap-[28px]'>
                  <img className=' w-14 h-14 bg-[#FFEFE8] p-[16px] rounded-[50px]'  src="./assets/adp/image6.png" />
                <div className='flex flex-col'>
              <h1 className='font-[Poppins] font-semibold text-lg leading-[27px] text-[#414141]'>
              Money-back guarantee
              </h1>
              <p className='font-[Poppins] font-medium text-xs leading-[18px] text-[#9F9F9F]'>Not in love with Penji by 30 days? Let us know and receive a full refund, hassle-free.</p>
              </div>
              </div>
              </div>
            </div>
          ...
          <div className='flex flex-row lg:flex-row'>
            ...
            <img  src='assets/img/phone1.png' alt='Iconbtn'/>
          </div>
          </div>
          <h1 className='font-[Poppins] font-semibold text-[64px] leading-[72px] text-center gap-[68px] text-[#414141]'>PLANS THAT<br/> WORK FOR YOU</h1>
            ...
            <div className='flex flex-col lg:flex-row gap-[34px]'>
              <div className='flex flex-col items-center p-6 gap-[33px] h-[545px] w-[317px] bg-[#F9F7F7] border-solid border-[1px] border-[#CED2D3]'>
               <div className='w-[256px] h-[161px] gap-2'>
                <h1 className='font-sans font-bold text-3xl leading-[39px] text-[#E9520B]'>Bulanan</h1>
                <p className='font-sans font-normal text-lg leading-6 text-[#455A64]'>Hanya <span className='line-through'>Rp 5.000.000</span> </p>
              ...
              <div className='flex flex-col gap-[21px] w-[251px] h-[182px]'>
                <h1 className='font-sans font-medium text-lg leading-6 text-[#455A64]'>Yang kamu dapat:</h1>
              <div className='flex flex-cols gap-[15.23px]'>
              <img src='assets/adp/icon-ckls.png'/>
              <p className='font-sans font-medium text-lg text-[#455A64]'>1 Bulan Durasi</p>
              </div>
              <div className='flex flex-row gap-[15.23px]'>
              <img src='assets/adp/icon-ckls.png'/>
              <p className='font-sans font-medium text-lg text-[#455A64]'>Dedicated Designer Team</p>
              </div>
              <div className='flex flex-row gap-[15.23px]'>
              <img src='assets/adp/icon-ckls.png'/>
              <p className='font-sans font-medium text-lg text-[#455A64]'>Unlimited Revision</p>
              </div>
              </div>
              </div>
              <div className='flex flex-col items-center p-6 gap-[33px] h-[545px] w-[317px] bg-[#F9F7F7] border-solid border-[1px] border-[#CED2D3]'>
               <div className='w-[256px] h-[161px] gap-2'>
                <h1 className='font-sans font-bold text-3xl leading-[39px] text-[#E9520B]'>PRO</h1>
                <p className='font-sans font-normal text-lg leading-6 text-[#455A64]'>Hanya <span className='line-through'>Rp 5.000.000</span> </p>
                <p className='font-sans font-bold text-[40px] leading-[52px] text-[#455A64]'>Rp.1.500.000</p>
                <p className='font-sans font-normal text-[18px] leading-[23px] text-[#455A64]'>/ Month</p>
                </div>
              ...
              <div className='flex flex-col items-center p-6 gap-[33px] h-[545px] w-[317px] bg-[#F9F7F7] border-solid border-[1px] border-[#CED2D3]'>
               <div className='w-[256px] h-[161px] gap-2'>
                <h1 className='font-sans font-bold text-3xl leading-[39px] text-[#E9520B]'>Minguuan</h1>
                <p className='font-sans font-normal text-lg leading-6 text-[#455A64]'>Hanya <span className='line-through'>Rp 5.000.000</span> </p>
                <p className='font-sans font-bold text-[40px] leading-[52px] text-[#455A64]'>Rp.1.500.000</p>
                <p className='font-sans font-normal text-[18px] leading-[23px] text-[#455A64]'>/ Month</p>
                </div>
          ...
          <div className='flex flex-col items-center gap-[23px]'>
            <h1 className='font-[Poppins] font-semibold text-[64px] leading-[71px] text-[#414141] text-center'>If you can imagine it,<br/>
we can design it.</h1>
